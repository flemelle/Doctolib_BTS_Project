...
<table>
    ...
    <tr>
        ...
        <td><?= $row['address']; ?></td>
        <td>
            <form method ="get" action = "index.php?page=patien" class ='iconForm'>
                <input type = 'text' name = 'idUser' value = <?= $row['idUser']; ?> hidden />
                <input type = 'text' name = 'page' value = 'patient' hidden />
        ...
        <td>
            <form method ="get" action = "index.php?page=patient" class ='iconForm'>
                <input type = 'text' name = 'idUser' value = <?= $row['idUser']; ?> hidden />
                <input type = 'text' name = 'page' value = 'patient' hidden />
