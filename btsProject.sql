...
--
-- Host: localhost:3306
-- Generation Time: May 03, 2024 at 01:19 AM
...
--
-- Stand-in structure for view `btsProject_Appointment_Users`
-- (See below for the actual view)
--
CREATE TABLE `btsProject_Appointment_Users` (
...
--
-- Stand-in structure for view `btsProject_Prescription_Users`
-- (See below for the actual view)
--
CREATE TABLE `btsProject_Prescription_Users` (
`content` text
...
(4, 'Update', 'Hayfa', 46, 'quam.vel@hotmail.ca', 'P.O. Box 918, 5289 Erat, Av.', 'NFS68PQN2OW', 'patient'),
...
(203, 'Nom', 'Prénom', 54, 'mailmail@mail', '23 rue chapell', '', 'patient'),
(204, 'Nouvel', 'Utilisateur', 54, 'mail@mail', 'adress', '', 'patient'),
(205, 'Huger', 'Marcel', 63, 'marcel@mail.com', '', '', 'patient');

-- --------------------------------------------------------

--
-- Stand-in structure for view `btsProject_User_Doctor`
-- (See below for the actual view)
--
CREATE TABLE `btsProject_User_Doctor` (
`address` varchar(255)
,`age` mediumint
...
--
-- Stand-in structure for view `btsProject_User_Patient`
-- (See below for the actual view)
--
CREATE TABLE `btsProject_User_Patient` (
`address` varchar(255)
,`age` mediumint
,`firstName` varchar(255)
,`idUser` mediumint
...
--
DROP TABLE IF EXISTS `btsProject_User_Doctor`;
...
--
ALTER TABLE `btsProject_User`
  MODIFY `idUser` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
COMMIT;
