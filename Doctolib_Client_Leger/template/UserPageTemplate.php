...
<div class ='form' > 
    <form method ="get" action ="index.php">
        <input type ="text" name = "page" value ="<?= $this -> page?>" hidden></input>
        ...
        <div class = 'formInputDisplay'><label>Rôle</label><input type ="text" placeholder = "Rôle" name = "role" value ="<?= $data["role"]?>"></input></div>
        <div><input type ="submit" value ="Sauvegarder" name = "formName" <?= $this -> submitHidden ?>></input></div>
    </form>
    <button <?= $this -> mofidyButton ?> onclick="window.location.href='index.php?page=<?=$page?>&action=update'">Modifier</button> 
</div>
